...
const {validateId, validateEvent, validateRSVP} = require('../middlewares/validator');
...
router.post('/', isLoggedIn, validateEvent, upload.single('image'), controller.create);

// {GET /events/:id} send details of story identified by id
router.get('/:id', validateId, controller.show);

// {POST /events/:id/rsvp/:action} create a new rsvp selection for event
router.post('/:id/rsvp/:action', validateId, validateRSVP, isLoggedIn, isNotHost, controller.rsvp);
